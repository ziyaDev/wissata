      ...
      <div className="flex space-x-2">
        <Drawer.Root>
          ...
          <Drawer.Portal>
            ...
            <Drawer.Content className=" z-50 flex flex-col  rounded-t-[10px] h-[75%]  fixed bottom-0 left-0 right-0">
              <div className="p-4 flex  flex-col  bg-card border-t rounded-t-[10px] flex-1">
                <div className="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-zinc-300 mb-8" />
                <div className=" w-full max-w-5xl mx-auto">
                  <MergePlaintForm data={row.original} />
                </div>
              </div>
            </Drawer.Content>
          </Drawer.Portal>
